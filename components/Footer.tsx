        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              A modern platform for writers and readers to connect through insightful content across diverse topics.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/webstories" className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400">
                  Web Stories
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Join our newsletter to get the latest updates and articles.
            </p>
            <form className="flex flex-col sm:flex-row gap-2">
              <input
                type="email"
                placeholder="Your email address"
                className="px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white flex-grow"
              />
              <button
                type="button"
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-600 dark:text-gray-400 text-sm mb-4 md:mb-0">
              © {year} Bloggers Ground. All rights reserved.
            </p>
